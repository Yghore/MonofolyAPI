                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                                ...
                                <!-- Counter - Alerts -->
                                <span class="badge badge-danger badge-counter">XX</span>
                            </a>
                            <!-- Dropdown - Alerts -->
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div class="font-weight-bold">
                                        <div class="text-truncate">Bienvenue sur la démo de MonofolyAPI</div>
                                        <div class="small text-gray-500">Yghore plisus · Maintenant</div>
                                    </div>
                                </a>
                                <a class="dropdown-item text-center small text-gray-500" href="#">Contacter le support</a>
                            </div>
                        </li>
...
@endauth
    ...
    <div class="mt-4 text-center">
        ...
        <a href="{{ route('home') }}">&larr; Retourner en arrière</a>
    </div>
